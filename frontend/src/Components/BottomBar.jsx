...
import { EmojiEvents, Assignment, TouchApp, LocalFireDepartment } from '@mui/icons-material';

const BottomBar = ({ onNavigate }) => {
  return (
    <Box position="fixed" bottom={0} width="100%" display="flex" justifyContent="space-around" py={2}>
      <IconButton onClick={() => onNavigate('referral')} sx={{
        color: '#fff', flexDirection: 'column', alignItems: 'center', bgcolor: '#699ae842',
        borderRadius: 3,
        width: '60px',
      ...
      <IconButton onClick={() => onNavigate('tasks')} sx={{
        color: '#fff', flexDirection: 'column', alignItems: 'center', bgcolor: '#699ae842',
        borderRadius: 3,
        boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19)',
        width: '60px',
      ...
      <IconButton onClick={() => onNavigate('earn')} sx={{
        color: '#fff', flexDirection: 'column', alignItems: 'center', bgcolor: '#699ae842',
        borderRadius: 3,
        boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19)',
        width: '60px',
      ...
      <IconButton onClick={() => onNavigate('boosts')} sx={{
        color: '#fff', flexDirection: 'column', alignItems: 'center', bgcolor: '#699ae842',
        borderRadius: 3,
        boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19)',
        width: '60px',
